...
const AboutDoctorEdit = () => {
  ...
  useEffect(() => {
    if (specificDoc) {
      setDocData({
        name: specificDoc.name || "",
        dob: specificDoc.dob || "",
        mobile: specificDoc.mobileno || "",
        role: specificDoc.role || "",
        gender: specificDoc.sex || "",
        email: specificDoc.email || "testing@gmail.com",
        education: specificDoc.education || "M.B.B.S",
        fee: specificDoc.fee || "500",
        clinicName: specificDoc.cliniName || "Dr.Karunakaran Spine Center"
      });
    }
  }, [specificDoc]);
      ...
      <div className=" m-3 profile-container pt-1">
        <div className="d-flex  profile-red-container">
          ...
          <div className="profile-docname-div ms-2 ">
            <p className="text-white mt-4 profile-doc-name">{DocData.name}</p>
