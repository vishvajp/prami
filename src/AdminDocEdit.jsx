...
const AdminDocEdit = () => {
    const aboutDocNavigate = useNavigate();
      ...
      const handleAboutNavigate = () => {
        setSelectedBtnName("DOCTOR")
        setSelectedButton(3)
        aboutDocNavigate("/home/admin/adminsetting");
      };
    ...
    <div>
         <div className=" m-3 profile-container pt-1">
           ...
           <div className="d-flex justify-content-center gap-2">
            <button style={{marginTop:"15px"}} className="medicalhistory-back-button" onClick={handleAboutNavigate}>CANCEL</button>
